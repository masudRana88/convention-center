...
const NavBar = () => {
    return (
        // <!-- Navbar -->
        <div className="fixed z-50 w-full bg-bgMain ">
        <div className="container flex items-start justify-between w-full p-5 mx-auto md:flex-row ">
          ...
          <div className="offcanvas offcanvas-end fixed bottom-0 flex flex-col max-w-[50%] bg-white invisible bg-clip-padding shadow-sm outline-none transition duration-300 ease-in-out text-gray-700 top-0 right-0 border-none w-96" tabIndex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
