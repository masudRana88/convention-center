                ...
                <div className="carousel-item active relative float-left w-full ">
                    <div className='my-slider-1 my-slider my-slider-filter '>
                        ...
                        <div className='flex-wrap flex items-center justify-center px-2 absolute bottom-14 left-2/4 -translate-x-1/2 md:w-[639px] w-full '>
                            ...
                            <motion.button whileTap={{ scale: 0.98  }} type="button" className="mt-8 text-blue-600 mx-auto inline-block px-16 py-3 bg-white font-medium text-base leading-tight uppercase rounded-xl shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0  active:shadow-lg transition duration-150 ease-in-out">
                                Book Now
                            </motion.button>
                        </div>
                    </div>
